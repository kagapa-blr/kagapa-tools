...
const API_ENDPOINTS = {
    ...
    AUTH: {
        ...
        SIGNUP: `${BASE_URL}/api/v1/users/signup`, // signup still on /users
    },
    ...
    USERS: {
        ...
        GET: (userId) => `${BASE_URL}/api/v1/users/${userId}`,
        UPDATE: (userId) => `${BASE_URL}/api/v1/users/${userId}`,
        DEACTIVATE: (userId) => `${BASE_URL}/api/v1/users/${userId}/deactivate`,
        ACTIVATE: (userId) => `${BASE_URL}/api/v1/users/${userId}/activate`,
    },
    ...
    MAIN_DICTIONARY: {
        ...
        CHECK: (word) =>
            `${BASE_URL}/api/v1/dictionary/main/check/${encodeURIComponent(word)}`,
